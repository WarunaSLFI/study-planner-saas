              ...
              <table className="min-w-full divide-y divide-slate-200 text-left">
                <thead className="bg-slate-50 sticky top-0">
                  <tr>
                    ...
                    <th className="px-3 py-3 text-lg font-semibold text-slate-700">Subject Name</th>
                    <th className="px-3 py-3 text-lg font-semibold text-slate-700">Subject Code</th>
                      ...
                      <tr key={row.id}>
                        ...
                        <td className="p-3">
                          <input
                            ...
                            className="w-full border-0 bg-transparent p-0 text-lg text-slate-700 focus:ring-0"
                          />
                        </td>
                        <td className="p-3">
                          <input
