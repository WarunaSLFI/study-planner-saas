...
export default function Sidebar() {
  return (
    <aside className="w-full border-b border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 md:fixed md:inset-y-0 md:left-0 md:w-64 md:border-b-0 md:border-r">
